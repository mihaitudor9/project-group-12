...
public class valuesGUI extends JFrame
{
    ...
    public valuesGUI()
    {
        ...
        ActionListener listener = new ActionListener()
        {
            ...
            {
                time.setText("Time:" + Double.toString(LunarLander.t) + " sec");
                height.setText("Height:  " + Double.toString(LunarLander.height) + " m");
                velocity.setText("Descent rate: " + Double.toString(LunarLander.velocity) + "m/sec");
                axis.setText("Change from initial axis: " + Double.toString(LunarLander.x - 2) + " m");
                
                fuel.setText("Fuel left: " + Double.toString(LunarLander.fuel) + " kg");
                thrust.setText("Thrust percentage + " + Double.toString(LunarLander.thrust) + "%");
               
                leftThrust.setText("Thrust percentage + " + Double.toString(LunarLander.leftThrust) + "%");
                rightThrust.setText("Thrust percentage + " + Double.toString(LunarLander.rightThrust) + "%");
            }
        };
        velocity = new JLabel();
        time = new JLabel();
